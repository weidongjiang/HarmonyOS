...
interface IsLeapYearCustomDialog_Params {
    content?: string;
    result?: boolean;
...
import { isLeapYear } from "@bundle:com.example.arktsalgorithm/entry/ets/common/utils/Method";
export class IsLeapYearCustomDialog extends ViewPU {
    ...
    setInitiallyProvidedValue(params: IsLeapYearCustomDialog_Params) {
    ...
    updateStateVars(params: IsLeapYearCustomDialog_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/IsLeapYearCustomDialog.ets(28:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/IsLeapYearCustomDialog.ets(29:7)", "entry");
            Column.alignItems(HorizontalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/IsLeapYearCustomDialog.ets(30:9)", "entry");
        ...
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777226, "type": 10003, params: [], "bundleName": "com.example.arktsalgorithm", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/IsLeapYearCustomDialog.ets(35:9)", "entry");
        ...
        Column.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TextInput.create({ placeholder: CommonConstants.LEAP_YEAR_INPUT });
            TextInput.debugLine("entry/src/main/ets/view/IsLeapYearCustomDialog.ets(44:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/IsLeapYearCustomDialog.ets(51:7)", "entry");
