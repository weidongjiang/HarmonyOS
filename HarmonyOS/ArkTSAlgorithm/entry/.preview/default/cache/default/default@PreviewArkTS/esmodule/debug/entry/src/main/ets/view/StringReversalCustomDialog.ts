...
export class StringReversalCustomDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/StringReversalCustomDialog.ets(28:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/StringReversalCustomDialog.ets(29:7)", "entry");
            Column.alignItems(HorizontalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/StringReversalCustomDialog.ets(30:9)", "entry");
        ...
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777230, "type": 10003, params: [], "bundleName": "com.example.arktsalgorithm", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/StringReversalCustomDialog.ets(35:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/view/StringReversalCustomDialog.ets(44:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/StringReversalCustomDialog.ets(51:7)", "entry");
