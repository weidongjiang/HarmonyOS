...
interface MultiplicationTableCustomDialog_Params {
...
export class MultiplicationTableCustomDialog extends ViewPU {
    ...
    setInitiallyProvidedValue(params: MultiplicationTableCustomDialog_Params) {
    ...
    updateStateVars(params: MultiplicationTableCustomDialog_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/MultiplicationTableCustomDialog.ets(23:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/MultiplicationTableCustomDialog.ets(24:7)", "entry");
            Column.alignItems(HorizontalAlign.Center);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/MultiplicationTableCustomDialog.ets(25:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/MultiplicationTableCustomDialog.ets(30:9)", "entry");
        ...
        Column.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777231, "type": 10003, params: [], "bundleName": "com.example.arktsalgorithm", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/MultiplicationTableCustomDialog.ets(39:7)", "entry");
